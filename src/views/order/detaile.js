...
class Detail extends Component {
    ...
    drawBikeRoute=(position_list)=>{
        ...
        const startIcon=new BMap.Icon("../../imgs/start.png",new BMap.Size(36,42),{
            imageSize:new BMap.Size(36,42)
        });
        //生成结束坐标点
        const endMapPoint=new window.BMap.Point(endPoint.lon,endPoint.lat);
        const endIcon=new BMap.Icon("../../imgs/end.png",new BMap.Size(36,42),{
            imageSize:new BMap.Size(36,42)
        });
        //设置标记
                ...
                <Card title="骑行地图">
                    ...
                    <div className="detail-info">
                        ...
                        <ul className="info-wrap">
                            ...
                            <li>
                                <span className="info-left">行程里程</span>
